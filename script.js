...
// xhr1.open('GET', 'https://api.dictionaryapi.dev/api/v2/entries/en_US/hello', true);

// xhr1.onload = function () {
//     if (this.status === 200) {
//         obj = JSON.parse(this.responseText)[0];
//         // let textline = JSON.stringify(obj.meanings[0].definitions[0].synonyms);
//         console.log(obj);
//         // console.log(JSON.stringify(obj.meanings[0].definitions[0].synonyms));
//         // console.log(obj.meanings[0].definitions[0]);
//         // console.log(obj.phonetics[0].text);
...
// xhr1.send();
        ...
        // `<div class="card-body bg-light rounded-2 shadow my-4">
        //     <h1 class="card-title mx-3">${obj.meanings[0].partOfSpeech}</h1>
        //     <hr>
        //     <div class="textbox px-3">
        //         <h3 class="card-text">Definition :</h3>
        //         <p class="card-text fs-4" style="color: grey;">${obj.meanings[0].definitions[0].definition}</p>
        //         <h3 class="card-text">Synonyms :</h3>
        //         <p class="card-text fs-4" style="color: grey;">${JSON.stringify(obj.meanings[0].definitions[0].synonyms)}</p>
        //         <hr>
        //         <h3 class="card-text">Examples :</h3>
        //         <p class="card-text fs-4" style="color: grey;">${obj.meanings[0].definitions[0].example}</p>    
        //     </div>
        // </div>
        // <div class="card-body bg-light rounded-2 shadow my-4">
        //     <h1 class="card-title mx-3">${obj.meanings[1].partOfSpeech}</h1>
        //     <hr>
        //     <div class="textbox px-3">
        //         <h3 class="card-text">Definition :</h3>
        //         <p class="card-text fs-4" style="color: grey;">${obj.meanings[1].definitions[0].definition}</p>
        //         <hr>
        //         <h3 class="card-text">Examples :</h3>
        //         <p class="card-text fs-4" style="color: grey;">${obj.meanings[1].definitions[0].example}</p>    
        //     </div>
        // </div>
        // <div class="card-body bg-light rounded-2 shadow my-4">
        //     <h1 class="card-title mx-3">${obj.meanings[2].partOfSpeech}</h1>
        //     <hr>
        //     <div class="textbox px-3">
        //         <h3 class="card-text">Definition :</h3>
        //         <p class="card-text fs-4" style="color: grey;">${obj.meanings[2].definitions[0].definition}</p>
        //         <hr>
        //         <h3 class="card-text">Examples :</h3>
        //         <p class="card-text fs-4" style="color: grey;">${obj.meanings[2].definitions[0].example}</p>    
        //     </div>
        // </div>`
        // }
